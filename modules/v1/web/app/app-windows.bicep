...
@description('Required the App Insights Scope')
param appInsSubscriptionId string

@description('Required the App Insights Scope')
param appInsRgName string
...
resource appInsightsRg 'Microsoft.Resources/resourceGroups@2022-09-01' existing = {
  name:appInsRgName
  scope:subscription(appInsSubscriptionId) 
}
