...
param vaultName string = 'rsv-backup'
...
var protectionContainer = 'iaasvmcontainer;iaasvmcontainerv2;${shdsvcRgName};${virtualMachineNameSuffix}'
var protectedItem = 'vm;iaasvmcontainerv2;${shdsvcRgName};${virtualMachineNameSuffix}'
var storageAccountId = resourceId(shdsvcRgName, 'Microsoft.Storage/storageAccounts', dscStorageAccount)
...
resource recoveryServicesVault 'Microsoft.RecoveryServices/vaults@2022-01-01' existing = if(enableBackup) {
  name: vaultName
}

resource vaultName_backupFabric_protectionContainer_protectedItem 'Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2022-01-01' = [for i in range(0, vmCount) : if(enableBackup) {
  name: '${vaultName}/${backupFabric}/${protectionContainer}/${protectedItem}${format('{0:D2}',i)}'
  properties: {
...
// //dsc configurations
// resource dscextension 'Microsoft.Compute/virtualMachines/extensions@2020-12-01' = [for i in range(0, vmCount): {
//   name: '${virtualMachineNameSuffix}${format('{0:D2}',i)}/dscextension'
//   location: location
//   properties: {
...
//     protectedSettings: {
//       Items: {
//         Key1: listKeys(storageAccountId, '2019-06-01').keys[0].value
//       }
//     }
//     settings: {
//       modulesUrl: configFilePath
//       configurationFunction: 'Configuration.ps1\\SgSoftwareInstall'
//       properties: dscProperties
//     }
//   }
//   dependsOn: [
//     vm[i]
//     extension_domainJoin[i]
//   ]
// }]
