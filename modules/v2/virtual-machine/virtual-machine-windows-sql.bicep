...
param tempDBPath string = 'G:\\SQLTemp'
...
//dsc configurations
resource dscextension 'Microsoft.Compute/virtualMachines/extensions@2022-08-01' = [for i in range(0, vmCount): {
